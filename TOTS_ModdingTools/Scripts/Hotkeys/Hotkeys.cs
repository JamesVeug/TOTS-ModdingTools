...
namespace TOTS_ModdingTools
{
    ...
    public static partial class Hotkeys
    {
        ...
        private static Dictionary<string, InputActionMap>
            modNameToActionMaps = new Dictionary<string, InputActionMap>();
        ...
        public static Hotkey New(string guid, string keyName, string displayName, List<KeyCode> codes,
        ...
        public static Hotkey New(string modName, string keyName, string displayName, List<KeyCode> codes,
            Action<InputAction.CallbackContext> callback = null)
        {
            var item = new Hotkey();
        ...
        public static Hotkey Add(string modName, Hotkey hotkey)
        {
            ...
            APILogger.IsFalse(HotKeyExists(modName, hotkey.keyName),
                $"Adding Hotkey with modName {modName} and keyName {hotkey.keyName} that already exists!");
        ...
        private static void CallbackAction(InputAction action, string keyName,
