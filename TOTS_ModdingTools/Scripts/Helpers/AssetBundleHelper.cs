...
public static class AssetBundleHelper
{
    ...
    public static bool TryGet<T>(AssetBundle bundle, string prefabName, out T prefab) where T : Object
    {
        ...
        if (prefab == null)
        {
            APILogger.LogError($"Tried getting prefab '{prefabName}' from asset bundle but failed! Is the prefab name or type wrong?");
            return false;
        }
    ...
    public static bool TryGet<T>(string pathToAssetBundle, string prefabName, out T prefab) where T : Object
    {
        ...
        if (bundle == null)
        {
            APILogger.LogError($"Tried getting asset bundle at path: '{pathToAssetBundle}' but failed! Is the path wrong?");
            prefab = default(T);
            return false;
        }
        ...
        if (prefab == null)
        {
            APILogger.LogError($"Tried getting prefab '{prefabName}' from asset bundle at path: '{pathToAssetBundle}' but failed! Is the prefab name or type wrong?");
            return false;
        }
    ...
    public static bool TryGet<T>(byte[] resources, string prefabName, out T prefab) where T : Object
    {
        ...
        if (prefab == null)
        {
            APILogger.LogError($"Tried getting prefab '{prefabName}' from asset bundle from bytes' but failed! Is the prefab name or type wrong?");
            return false;
        }
