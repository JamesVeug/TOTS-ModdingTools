    ...
    public static class JSONSerializer
    {
        ...
        public class UnityObjectConverter : JsonConverter
        {
            ...
            public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
            {
                ...
                // }
                /* else */
                if (unityObject is Texture2D texture)
                {
                    string path = writerPath + ".png";
                    SubObjectsList.Add(new SubObjects()
                    {
        ...
        public static void DumpPerksToJSON<T>(T[] effectModels, string key) where T : ScriptableObject
        {
            ...
            foreach (var model in effectModels)
            {
                try
                {
                    ...
                    string path = Path.Combine(ModdingToolsPlugin.PluginDirectory, "Exports", key, model.name) +
                                  ".json";
                    ...
                    {
                        string subPath = Path.Combine(ModdingToolsPlugin.PluginDirectory, "Exports", "Assets",
