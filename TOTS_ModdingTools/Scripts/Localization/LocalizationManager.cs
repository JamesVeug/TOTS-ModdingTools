...
public static partial class LocalizationManager
{
    ...
    private static readonly List<LanguageData> s_supportedlanguages = new List<LanguageData>()
    {
        ...
        new LanguageData() { Language = SystemLanguage.Spanish,             Code = "es",        CultureCode = "es" },
        new LanguageData() { Language = SystemLanguage.Spanish,             Code = "es-LA",     CultureCode = "es-LA" }, // Latin America
        ...
        new LanguageData() { Language = SystemLanguage.Portuguese,          Code = "pt-BR",     CultureCode = "pt-BR" },
        ...
        new LanguageData() { Language = SystemLanguage.ChineseTraditional,  Code = "zh-TW",     CultureCode = "zh-Hant" },
        new LanguageData() { Language = SystemLanguage.German,              Code = "de",        CultureCode = "de-DE" },
        new LanguageData() { Language = SystemLanguage.Thai,                Code = "tr",        CultureCode = "th-TH" },
    };
    ...
    public static void Instantiate()
    {
        ...
        //
        // string path = files[0];
        // LoadTSV(Plugin.PLUGIN_GUID, path);
    }
    ...
    {
        SystemLanguage language = CodeToLanguage(ArticyDatabase.Localization.Language);
    ...
    {
        Dictionary<string, string> textsService = ArticyDatabase.Localization.LocalizedStrings;
